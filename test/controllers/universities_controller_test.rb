...
class UniversitiesControllerTest < ActionController::TestCase
  ...
  test "should create university" do
    assert_difference('University.count') do
      post :create, university: { image: @university.image, location: @university.location, name: @university.name, owner_id: @university.owner_id }
    end
  ...
  test "should update university" do
    patch :update, id: @university, university: { image: @university.image, location: @university.location, name: @university.name, owner_id: @university.owner_id }
    assert_redirected_to university_path(assigns(:university))
  end
